                            ...
                            <div class="row">
                                <div class="col-lg-8 details order-2 order-lg-1">
                                    ...
                                    <p class="font-italic">Eos voluptatibus quo. Odio similique illum id quidem non enim
                                        fuga. Qui natus non
                                        sunt dicta dolor et. In asperiores velit quaerat perferendis aut</p>
                            ...
                            <div class="row">
                                <div class="col-lg-8 details order-2 order-lg-1">
                                    ...
                                    <p>Eaque consequuntur consequuntur libero expedita in voluptas. Nostrum ipsam
                                        ...
                                        Eligendi asperiores sed
                                        qui veritatis aperiam quia a laborum inventore</p>
                                </div>
                                <div class="col-lg-4 text-center order-1 order-lg-2">
                            ...
                            <div class="row">
                                <div class="col-lg-8 details order-2 order-lg-1">
                                    ...
                                    <p>Exercitationem nostrum omnis. Ut reiciendis repudiandae minus. Omnis recusandae
                                        ut non quam ut quod
                                        eius qui. Ipsum quia odit vero atque qui quibusdam amet. Occaecati sed est sint
                                        aut vitae molestiae
                                        voluptate vel</p>
                                </div>
                                <div class="col-lg-4 text-center order-1 order-lg-2">
